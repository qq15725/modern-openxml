...
export function parseTheme(theme: OOXMLNode, id: string): Theme {
  ...
  return {
    colorScheme: parseColorScheme(theme.find('a:themeElements/a:clrScheme')),
    extraColorMap: parseColorMap(theme.find('a:extraClrSchemeLst/a:extraClrScheme/a:clrMap')),
    extraColorScheme: parseColorScheme(theme.find('a:extraClrSchemeLst/a:extraClrScheme/a:clrScheme')),
    fontScheme: parseFontScheme(theme.find('a:themeElements/a:fontScheme')),
    fillStyleList: fmtScheme?.get('a:fillStyleLst/*').map(node => parseFill(node)!),
